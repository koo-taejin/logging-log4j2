...
@State(Scope.Thread)
public class FileAppender2Benchmark {
    ...
    public void setUp() throws Exception {
        ...
        log4j2Logger = LogManager.getLogger(FileAppender2Benchmark.class);
    ...
    public void log4j2RollingFileAppender() {
        rollingFileAppender.debug(MESSAGE);
    }
